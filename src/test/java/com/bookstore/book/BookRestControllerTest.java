...
public class BookRestControllerTest {
  ...
  public void shouldReturnNewBookIdAfterAddingBook() throws Exception {
    ...
    this.mockMvc.perform(post("/books").contentType(MediaType.APPLICATION_JSON).content("""
        {"name":"Szumilas",
         "author":"Jacek",
         "publishYear":1999}
  ...
  public void shouldReturnTrueAfterBookUpdate() throws Exception {
    ...
    this.mockMvc.perform(put("/books/2").contentType(MediaType.APPLICATION_JSON).content("""
        {"name":"Szumilas",
         "author":"Jacek",
         "publishYear":1999}
